  ...
  return (
    <section ref={ref} className='mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]' id="home">
      ...
      >
        ...
        <a className='bg-white text-gray-700 p-4 flex text-[1.35rem] items-center gap-2 rounded-full outline-none focus:scale-[1.15] hover:scale-[1.15]  active:scale-[1.15] transition borderBlack hover:text-gray-950' href='https://linkedin.com' target='_blank'><BsLinkedin className=''/></a>
        
        
        <a className='bg-white text-gray-700 p-4 flex items-center gap-2 rounded-full text-[1.35rem] outline-none focus:scale-[1.15] hover:scale-[1.15] active:scale-[1.15] transition  hover:text-gray-950  borderBlack' href='https://github.com' target='_blank'><FaGithubSquare /></a>
      </motion.div>
    </section>
